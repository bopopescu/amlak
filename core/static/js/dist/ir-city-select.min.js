var data={
	...
	"خراسان جنوبي":
	["بيرجند","سربيشه","فردوس","قائن","نهبندان"],
	"خراسان رضوي":
	["بردسکن","تايباد","تربت جام","تربت حيدريه","خواف","خلیل آباد","درگز","سبزوار","سرخس","طبس","طرقبه","فريمان","قوچان","كاشمر","مشهد","نيشابور","چناران","گناباد"],
	"خراسان شمالي":
...
var loadProvinces=function(){
	var t=$(this);
	t.empty(),
	t.append($("<option></option>").attr("value","empty")),
